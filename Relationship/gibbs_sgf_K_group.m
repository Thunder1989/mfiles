function [Y,Z,M,Q,R] = gibbs_sgf_K(data, Ks, F_switch)
    %group version, with parameters shared among streams
    clc
   
    T = 7*4; % # of days
    
    path_ahu = strcat('./data_ahu');
    path_vav = strcat('./data_vav');
